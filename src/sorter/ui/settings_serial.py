...
class SerialSection(QWidget):
    ...
    def _build_connection_group(self) -> QGroupBox:
        ...
        # The traffic log lives in the bottom dock, and this page should say
        # so — a user configuring serial is exactly the one who wants to watch
        # it (JL).
    ...
    def _build_sort_arm_group(self) -> QGroupBox:
        ...
        # Connected last: the initial setValue above must not read as the user
        # requesting a move.
